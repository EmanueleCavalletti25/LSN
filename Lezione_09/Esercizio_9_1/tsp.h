...
class tsp{
    ...
    void initialize();  //function to initialize the system: shape and other parameters
    void initialize_prop(); //creation of repliche in the system
    Random _rnd;
    ...
    double write_loss_function();
    void write_loss_function_single();
    void write_best_path(mat pop);
