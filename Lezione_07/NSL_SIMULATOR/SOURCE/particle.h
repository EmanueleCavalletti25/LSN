...
private:
  ...
  int _spin;            // Spin of the particle (+1 or -1) //nel 4 non lo uso
...
public: // Function declarations
  ...
  double pbc(double position, double side);     // Apply periodic boundary conditions //TRUE IF I CONSIDER THE CELL SYMMETRIC
