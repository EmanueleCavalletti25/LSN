  ...
  while ( !input.eof() ){
      input >> property;
        ...
        case MODE1:
          if (_phase == "ISING"){
            if (_sim_type == 2){
            coutt.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_total_energy.dat");
            }else{coutt.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_total_energy.dat");}
          }else{coutt.open("../OUTPUT/"+ _phase +"/total_energy.dat");}
          break;
        case MODE2:
          if (_phase == "ISING"){
          if (_sim_type == 2 ){coutt.open("../OUTPUT/"+ _phase +"/METROPOLIS_total_energy_" + oss.str() + "_.dat");}
          if (_sim_type == 3 ){coutt.open("../OUTPUT/"+ _phase +"/GIBBS_total_energy_" + oss.str() + "_.dat");}
        break;
          }else{coutt.open("../OUTPUT/"+ _phase +"/total_energy.dat");}
        break;
        default:
        ...
        case MODE1:{
          ...
          }else{coutte.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/temperature_" + formatted_temp + ".dat");}
          break;
        }
        case MODE2:{
          coutte.open("../OUTPUT/"+ _phase +"/temperature_" + formatted_temp + ".dat");
        ...
        switch (mode){
        case MODE1:
          if (_sim_type == 2 ){coutmag.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_magnet_"+oss_m.str()+"_.dat");}
          if (_sim_type == 3 ){coutmag.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_magnet_"+oss_m.str()+"_.dat");}
          break;
        
        case MODE2:
          if (_sim_type == 2 ){coutmag.open("../OUTPUT/"+ _phase +"/METROPOLIS_magnet_" + oss.str() + "_"+oss_m.str()+"_.dat");}
          if (_sim_type == 3 ){if(_H == 0){coutmag.open("../OUTPUT/"+ _phase +"/GIBBS_magnet_" + oss.str()+"_.dat");
          }else{coutmag.open("../OUTPUT/"+ _phase +"/GIBBS_magnet_" + oss.str() + "_"+oss_m.str()+"_.dat");}
        ...
        switch (mode){
        case MODE1:
          if (_sim_type == 2 ){coutcv.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_cv.dat");}
          if (_sim_type == 3 ){coutcv.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_cv.dat");}
          
          break;
        case MODE2:
          if (_sim_type == 2 ){coutcv.open("../OUTPUT/"+ _phase +"/METROPOLIS_cv_" + oss.str() + "_.dat");}
          if (_sim_type == 3 ){coutcv.open("../OUTPUT/"+ _phase +"/GIBBS_cv_" + oss.str() + "_.dat");}
        break;
        default:
        ...
        switch (mode){
        case MODE1:
          if (_sim_type == 2 ){coutchi.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_chi.dat");}
          if (_sim_type == 3 ){coutchi.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_chi.dat");}
          break;
        case MODE2:
          
          if (_sim_type == 2 ){coutchi.open("../OUTPUT/"+ _phase +"/METROPOLIS_chi_" + oss.str() + "_.dat");}
          if (_sim_type == 3 ){coutchi.open("../OUTPUT/"+ _phase +"/GIBBS_chi_" + oss.str() + "_.dat");}
        break;
        default:
...
void System :: write_configuration(){
  ...
  if(_sim_type < 2){
    ...
    if (_sim_type == 2 ){
      if (_H== 0.){
      coutf.open("../OUTPUT/"+ _phase +"/CONFIG/METROPOLIS_config.spin");
      }else{coutf.open("../OUTPUT/"+ _phase +"/CONFIG/METROPOLIS_config_"+oss_m.str()+"_.spin");}
      }
    if (_sim_type == 3 ){if (_H== 0.){
      coutf.open("../OUTPUT/"+ _phase +"/CONFIG/GIBBS_config.spin");
      }else{coutf.open("../OUTPUT/"+ _phase +"/CONFIG/GIBBS_config_"+oss_m.str()+"_.spin");}
    }
...
void System :: read_configuration(){
  ...
  if(_restart and _sim_type > 1){
    ...
    ifstream cinf;
    if (_sim_type == 2 ){
      if(_H==0.){cinf.open("../OUTPUT/"+ _phase +"/CONFIG/METROPOLIS_config.spin");
      }else{cinf.open("../OUTPUT/"+ _phase +"/CONFIG/METROPOLIS_config_"+oss_m.str()+"_.spin");}
      
      
      }
    if (_sim_type == 3 ){
      if(_H==0.){cinf.open("../OUTPUT/"+ _phase +"/CONFIG/GIBBS_config.spin");
      }else{cinf.open("../OUTPUT/"+ _phase +"/CONFIG/GIBBS_config_"+oss_m.str()+"_.spin");}
    }
    for(int i=0; i<_npart; i++){
      cinf >> spin;
      _particle(i).setspin(spin);
...
void System :: measure(){ // Measure properties
  ...
  //if (_measure_tenergy and _measure_cv) { _measurement(_index_cv) = (pow(_beta,2)/(double)_npart) * (pow(_measurement(_index_tenergy)*_npart,2)-(pow(_measurement(_index_tenergy)*_npart,2)/(double)(_nsteps)));}                                                                 
...
void System :: averages(int blk, Mode mode){
  ...
  // TEMPERATURE /////////////////////////////////////////////////////////////////////
    ...
    // TOTAL ENERGY //////////////////////////////////////////////////////////////
      if (_measure_tenergy){
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_total_energy.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_total_energy.dat",ios::app);}
  ...
  // MAGNETIZATION /////////////////////////////////////////////////////////////
      ...
      if (_measure_magnet){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_magnet_"+oss_m.str()+"_.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_magnet_"+oss_m.str()+"_.dat",ios::app);}
      ...
      if (_measure_cv ){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_cv.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_cv.dat",ios::app);}
      ...
      if (_measure_chi ){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/METROPOLIS_chi.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/EQUILIBRATION/GIBBS_chi.dat",ios::app);}
...
///EVOLUTION CASE ////////////////////////////////////////////////////////////////////
    case MODE2:{
      ...
      if (_measure_tenergy){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/METROPOLIS_total_energy_" + oss.str() + "_.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/GIBBS_total_energy_" + oss.str() + "_.dat",ios::app);}
        }else{coutf.open("../OUTPUT/"+ _phase +"/total_energy.dat",ios::app);}
        average  = _average(_index_tenergy);
        sum_average = _global_av(_index_tenergy);
        sum_ave2 = _global_av2(_index_tenergy);
        coutf << setw(12) << blk
      ...
      if (_measure_magnet){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/METROPOLIS_magnet_" + oss.str() + "_"+oss_m.str()+"_.dat",ios::app);}
        if (_sim_type == 3 ){
          if(_H==0.){coutf.open("../OUTPUT/"+ _phase +"/GIBBS_magnet_" + oss.str() + "_.dat",ios::app);
          }else{coutf.open("../OUTPUT/"+ _phase +"/GIBBS_magnet_" + oss.str() + "_"+oss_m.str()+"_.dat",ios::app);}
        }
      ...
      if (_measure_cv){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/METROPOLIS_cv_" + oss.str() + "_.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/GIBBS_cv_" + oss.str() + "_.dat",ios::app);}
        average  = _average(_index_cv);
        sum_average = _global_av(_index_cv);
        sum_ave2 = _global_av2(_index_cv);
        coutf << setw(12) << blk
      ...
      if (_measure_chi){
        ...
        if (_sim_type == 2 ){coutf.open("../OUTPUT/"+ _phase +"/METROPOLIS_chi_" + oss.str() + "_.dat",ios::app);}
        if (_sim_type == 3 ){coutf.open("../OUTPUT/"+ _phase +"/GIBBS_chi_" + oss.str() + "_.dat",ios::app);}
        average  = _average(_index_chi);
        sum_average = _global_av(_index_chi);
        sum_ave2 = _global_av2(_index_chi);
        coutf << setw(12) << blk
