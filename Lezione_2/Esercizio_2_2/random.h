...
public:
  ...
  //method to generate angle between [0;2PI)
  double random_angle(void);
  //method to generate discrete random walk,that give the distance
  vector <double> RW3D_discreto(unsigned int steps );
  //method to generate continuum random walk,that give the distance
  vector <double> RW3D_continuum(unsigned int steps );
