...
public:
  ...
  // Method to generate new coordinate with uniform and gaussian distribution
  vec random_newcoord_unif(vec coord_old , double sigma); 
  vec random_newcoord_gauss(vec coord_old, double sigma);
};
